...
export default function InnovationStrategySection({ form }: { form: any }) {
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-blue-700">Innovation and Strategy</h3>
      ...
      <div className="grid gap-6">
        <RatingQuestion
          form={form}
          name="innovationStrategy.exploreOpportunities"
          question="Do you actively explore new opportunities for growth (e.g., products, services)?"
        />
        
        <RatingQuestion
          form={form}
          name="innovationStrategy.adaptToChanges"
          question="Do you adapt quickly to changes in your industry or market?"
        />
        
        <RatingQuestion
          form={form}
          name="innovationStrategy.clearVision"
          question="Do you have a clear vision and strategy for the next 3-5 years?"
        />
      </div>
    </div>
  );
