...
export default function TeamLeadershipSection({ form }: { form: any }) {
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-blue-700">Team and Leadership</h3>
      ...
      <div className="grid gap-6">
        <RatingQuestion
          form={form}
          name="teamLeadership.definedRoles"
          question="Do your employees have clearly defined roles and responsibilities?"
        />
        
        <RatingQuestion
          form={form}
          name="teamLeadership.teamCommunication"
          question="Do you regularly communicate and engage with your team?"
        />
        
        <RatingQuestion
          form={form}
          name="teamLeadership.taskDelegation"
          question="Are you able to delegate tasks effectively?"
        />
      </div>
    </div>
  );
