...
export default function OperationalEfficiencySection({ form }: { form: any }) {
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        <h3 className="text-xl font-semibold text-blue-700">Operational Efficiency</h3>
      ...
      <div className="grid gap-6">
        <RatingQuestion
          form={form}
          name="operationalEfficiency.streamlinedOperations"
          question="Are your daily operations streamlined and free of bottlenecks?"
        />
        
        <RatingQuestion
          form={form}
          name="operationalEfficiency.automationTechnology"
          question="Do you use technology to automate tasks where possible?"
        />
        
        <RatingQuestion
          form={form}
          name="operationalEfficiency.handleDemand"
          question="Can you handle increasing demand without delays or quality issues?"
        />
      </div>
    </div>
  );
